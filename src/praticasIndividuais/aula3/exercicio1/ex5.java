...
public class ex5 {
    public static void main(String[] args) {
        ...
        System.out.println("Digite a quantidade de números naturais a serem retornados");
        long amountOfNaturalNumbers = scanner.nextLong();
        System.out.println("Digite a quantidade de vezes que o digito será repetido");
        int amountofDigits = scanner.nextInt();
        int counter = 0;
        System.out.println("Digite o digito que será repetido");
        scanner.nextLine();
